...
| [Sprint lifecycle](sprint-lifecycle.md) | [Sprint-cycle skill](https://github.com/se-keller/agile-agentic-framework/blob/main/skills/run-sprint-cycle/SKILL.md) and its [references](https://github.com/se-keller/agile-agentic-framework/tree/main/skills/run-sprint-cycle/references/) |
