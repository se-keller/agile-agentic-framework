...
5. Keep the order in `product-backlog/index.md` authoritative. Never reuse a Product Backlog Item ID.
6. Select optional skills only when their metadata matches the current need. Use the smallest sufficient skill and record material methods used.
